export default {
    ...
    template: /*html*/`
        <section class="note flex align-center justify-center" 
            ...
            <img src="../../../assets/images/pin.png" title="pin this note" @click="$emit('noteAction', {action:'pin', note})" alt="" />
            <img src="../../../assets/images/edit.png" title="edit this note" @click="$emit('noteAction', {action:'edit', note})" alt="" />
            <img src="../../../assets/images/mail.png" title="send this note via gMail" @click="$emit('noteAction', {action: 'mail', note})" alt="" />
            <img src="../../../assets/images/delete.png" title="delete this note" @click="$emit('noteAction', {action:'remove', note})" alt="" />
        </div>
